...
#Get the cardinal direction of the boat: North, West, East etc.
...
#assigning a section of text for the text to speech algorithm to recite
...
#read the text assigned by text_to_speech function at your desired speed
def read_text(mytext, speed):

    #english language, normal speed, assigning text variable
    language = 'en'
    ...
    #adjusting the speed of the wav file
    ...
    #changing the speed back after playback
    spf = wave.open('newwelcomey.wav', 'rb')
    RATE=spf.getframerate()
    signal = spf.readframes(-1)
    print(RATE)
        ...
        for event in pygame.event.get():
            ...
            #Pressing the x Key will quit the game
                ...
                if event.key==pygame.K_1:
                    read_text(text_to_speech(1),speech_speed)
                if event.key==pygame.K_2:
                    read_text(text_to_speech(2),speech_speed)
                if event.key==pygame.K_3:
                    read_text(text_to_speech(3),speech_speed)
                if event.key==pygame.K_4:
                    read_text(text_to_speech(4),speech_speed)
                if event.key==pygame.K_5:
                    read_text(text_to_speech(5),speech_speed)
                if event.key==pygame.K_6:
                    speech_speed = 0.9
                    read_text(text_to_speech(6),speech_speed)
                if event.key==pygame.K_7:
                    speech_speed = 1.2
                    read_text(text_to_speech(7),speech_speed)
                if event.key==pygame.K_8:
                    speech_speed = 1.4
                    read_text(text_to_speech(8),speech_speed)
