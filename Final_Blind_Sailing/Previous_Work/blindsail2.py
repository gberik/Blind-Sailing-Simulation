...
while carryOn:
        ...
        if (BuoyPos[0]-radius < Boat1.pos.x < BuoyPos[0]+radius) and (BuoyPos[1]-radius < Boat1.pos.y < BuoyPos[1]+radius):
            Boat1.reset_boat()
        elif (BuoyPos[2]-radius < Boat1.pos.x < BuoyPos[2]+radius) and (BuoyPos[3]-radius < Boat1.pos.y < BuoyPos[3]+radius):
            Boat1.reset_boat()
        elif (BuoyPos[4]-radius < Boat1.pos.x < BuoyPos[4]+radius) and (BuoyPos[5]-radius < Boat1.pos.y < BuoyPos[5]+radius):
            Boat1.reset_boat()
